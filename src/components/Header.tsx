      ...
      <div className="flex items-center justify-between px-3 py-2.5">
        <div className="flex items-center gap-2.5">
          ...
          <h1 className="m-0 text-xl font-black italic tracking-wider leading-none select-none">
            <Link
              href="/"
              className="inline-block bg-gradient-to-r from-[#ff007f] via-[#ff3399] to-[#ff99dd] bg-clip-text text-transparent drop-shadow-[0_2px_10px_rgba(255,0,127,0.8)] hover:scale-105 transition-transform duration-200"
            >
              埼玉メンエス情報館
            </Link>
          </h1>
