    ...
    <div className="min-h-screen bg-neutral-950 text-slate-100 font-sans pb-16 selection:bg-[#e6007e] selection:text-white">
      ...
      <section id="register-step" className="max-w-sm mx-auto px-4 mb-8">
        <div className="bg-neutral-900 rounded-2xl p-5 shadow-2xl border border-neutral-800">
          ...
          {/* ステップ 01 */}
          <div className="mb-6 relative pl-10 border-l-2 border-dashed border-[#e6007e]">
            <span className="absolute -left-3 top-0 text-[#e6007e] font-black text-xl bg-neutral-900 px-1">
              01
            </span>
